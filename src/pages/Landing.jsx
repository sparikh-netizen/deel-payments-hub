...
const NAV_ITEMS = [
  { id: 'how-i-read',   label: 'How I read this' },
  { id: 'problem',      label: '1. The Problem' },
  { id: 'state-model',  label: '2. State Model' },
  { id: 'timelines',    label: '3. Timelines' },
  { id: 'risk',         label: '4. Risk' },
  { id: 'ux',           label: '5. UX' },
  { id: 'test-first',   label: '6. What to Test' },
      ...
      {NAV_ITEMS.map(item => (
        <a
          ...
          style={{
            ...
            borderRadius: 4,
            textDecoration: 'none',
            borderLeft: active === item.id ? '2px solid #6E3FF3' : '2px solid transparent',
            color: active === item.id ? '#6E3FF3' : '#6B7280',
            fontWeight: active === item.id ? 600 : 400,
            background: active === item.id ? '#F5F3FF' : 'transparent',
...
export default function Landing() {
  const [active, setActive] = useState('how-i-read')
  ...
  return (
    <div style={{ fontFamily: 'Inter, system-ui, sans-serif', background: '#fff', color: '#111', fontSize: 14, lineHeight: 1.6 }}>
      ...
      {/* Two-column layout */}
      <div style={{ maxWidth: 960, margin: '0 auto', padding: '48px 24px 96px', display: 'flex', gap: 48 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          <Section id="how-i-read" title="How I read this brief">
            <P>
          ...
          {/* 1. Problem */}
          <Section id="problem" n="1." title="The Problem: State Collapse">
            <P>
          ...
          {/* 2. State Model */}
          <Section id="state-model" n="2." title="System Design: State Model">
          ...
          {/* 3. Timelines */}
          <Section id="timelines" n="3." title="Funding Timelines">
            <P>
          ...
          {/* 4. Risk */}
          <Section id="risk" n="4." title="Risk Framework">
          ...
          {/* 5. UX */}
          <Section id="ux" n="5." title="UX: Payments Hub">
          ...
          {/* 6. What to Test */}
          <Section id="test-first" n="6." title="What I'd Test First">
            <Table
